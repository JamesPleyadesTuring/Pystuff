...
countries = ['Canada','Germany', 'United Kingdom', 'US', 'Mexico', 'France', 'China']
...
populations = {'Canada':37664517, 'Germany': 83721496 , 'United Kingdom': 67802690 , 'US': 330548815, 'Mexico': 128624325,'France': 65239883, 'China':1438027228}
percapita = covid.copy()
for country in list(percapita.columns):
	percapita[country] = percapita[country]/populations[country]*100000

#first visualization
colors = {'Canada':'#045275', 'China':'#089099', 'France':'#7CCBA2', 'Germany':'#FCDE9C', 'US':'#DC3977', 'United Kingdom':'#7C1D6F', 'Mexico':'#FFA500'}
plt.style.use('fivethirtyeight')

#creating the visualization
plot = covid.plot(figsize=(8,4), color = list(colors.values()), linewidth=5, legend=False)
...
plot.text(x = covid.index[1], y = int(covid.max().max())+15000, s = "For the USA, China, Germany, France, United Kingdom, Mexico and Canada\nIncludes Current Cases, Recoveries, and Deaths", fontsize = 16, alpha = .75)
...
percapitaplot = percapita.plot(figsize=(8,4), color=list(colors.values()), linewidth=5, legend=False)
